...
//hardcoding the data ... although we'd normally pull this off a server. More advanced stuff...

struct MusicLibrary {
    //dictionaries of playlists below:
    let library = [
        [
            "title": "Rise and Shine",  //key: value
        ...
        ], //this is a single dictionary (above)
        [
